namespace GameTool
{
    public static class GameDataControl
    {
        ...
        {
            GameData.Instance.SaveData(eData.AnimId, GameData.Instance.Data.AnimId);
            GameData.Instance.SaveData(eData.HighScore, GameData.Instance.Data.HighScore);
        ...
        {
            GameData.Instance.LoadData(eData.AnimId, ref GameData.Instance.Data.AnimId);
            GameData.Instance.LoadData(eData.HighScore, ref GameData.Instance.Data.HighScore);
